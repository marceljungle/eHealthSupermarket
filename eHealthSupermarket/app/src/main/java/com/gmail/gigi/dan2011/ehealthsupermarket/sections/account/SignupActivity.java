      ...
      public void onClick(View v) {
        ...
        if (password.length() < 6) {
          Toast.makeText(getApplicationContext(),
              "Contraseña demasiado corta, ingrese un mínimo de 6 carácteres", Toast.LENGTH_SHORT)
              .show();
          return;
        }
            ...
            .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
              ...
              public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (!task.isSuccessful()) {
                  ...
                  User user = new User("Change me", "Change me", "Change me", "Change me",
                      "Change me", new ArrayList<>(), new ArrayList<>(), new ArrayList<>(),
                      new ArrayList<>(), inputEmail.getText().toString(),
